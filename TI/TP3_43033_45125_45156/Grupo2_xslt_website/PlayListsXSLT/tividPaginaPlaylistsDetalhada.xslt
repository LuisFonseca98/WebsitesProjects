...
<li><a href = "../PlayLitsXSLT/PlaylistsGeral.xhtml">Playlists</a></li>
	...
	<p> Nesta página encontrará toda a informacao acerca da playlist Pra_Ver, e os respetivos vídeos que estão associados</p>
	<hr/>
<div class = "info">
    <xsl:for-each select="//Tivid/Playlists/playlist[@ip = 'p_2']/vid">
